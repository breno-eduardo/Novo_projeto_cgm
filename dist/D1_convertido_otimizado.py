...
# Verifica se um arquivo foi passado como argumento
if len(sys.argv) < 2:
    print("Erro: Nenhum arquivo Excel foi passado como argumento.")
    sys.exit(1)

arquivo_excel = sys.argv[1]  # Recebe o nome do arquivo passado pelo interface.py

# Mostra o caminho do arquivo antes de tentar abrir
print(f"Tentando abrir o arquivo: {arquivo_excel}")
...
# Abre o arquivo Excel com o caminho correto
